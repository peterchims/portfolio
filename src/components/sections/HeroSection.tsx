...
const HeroSection: React.FC = () => {
  return (
    <section id="home" className="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-72 h-72 bg-lime-400/10 rounded-full blur-3xl floating"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-green-400/10 rounded-full blur-3xl floating" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gray-300/5 rounded-full blur-3xl floating" style={{ animationDelay: '4s' }}></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen py-20">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-6 py-6 fade-in-up stagger-4">
              <div className="text-center">
                <CustomText variant="h3" font="roboto" weight="bold" color="gradient">
                  50+
                </CustomText>
          ...
          <div className="relative lg:block hidden">
            <div className="relative">
              ...
              <div className="glass-effect rounded-2xl p-8 shadow-xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-blue-400 to-blue-500 rounded-full w-3/5 animate-pulse" style={{ animationDelay: '0.5s' }}></div>
                    </div>
                    <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-purple-400 to-purple-500 rounded-full w-4/6 animate-pulse" style={{ animationDelay: '1s' }}></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Floating Cards */}
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-white rounded-xl shadow-lg flex items-center justify-center floating" style={{ animationDelay: '1s' }}>
                <CustomText variant="h5" font="roboto" weight="bold" color="gradient">
                  JS
                </CustomText>
              </div>
              
              <div className="absolute -bottom-4 -left-4 w-28 h-28 bg-white rounded-xl shadow-lg flex items-center justify-center floating" style={{ animationDelay: '3s' }}>
                <CustomText variant="h5" font="roboto" weight="bold" color="gradient">
                  TS
                </CustomText>
              </div>
