...
const ProjectsSection: React.FC = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'Mobile-first social platform with real-time messaging, media sharing, and social features.',
    ...
    },
    {
      ...
      description: 'Content management system with AI-assisted writing, SEO optimization, and analytics.',
                ...
                <div className="relative overflow-hidden rounded-xl shadow-lg group-hover:shadow-2xl transition-shadow duration-500">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="flex space-x-3">
                      ...
                      <CustomButton variant="primary" size="sm" icon={ExternalLink}>
                        Live Demo
                      </CustomButton>
                    </div>
                  </div>
              ...
              <div className={`space-y-6 ${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <CustomText variant="caption" weight="medium">Technologies Used:</CustomText>
                  </div>
