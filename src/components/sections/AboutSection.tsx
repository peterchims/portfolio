  ...
  const highlights = [
    {
      icon: User,
      title: 'Professional',
      description: 'Dedicated to delivering high-quality solutions with attention to detail.',
    },
    {
      icon: Award,
      title: 'Experienced',
    ...
    },
    {
      icon: Target,
      title: 'Goal-Oriented',
      description: 'Focused on achieving project objectives and exceeding expectations.',
    },
    {
      icon: Heart,
      title: 'Passionate',
      description: 'Love for clean code, innovative solutions, and continuous learning.',
    },
  ];
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              >
                ...
                My journey in software development has been driven by curiosity and a commitment to creating 
              ...
              >
                ...
                projects, or mentoring fellow developers. I believe in the power of technology to solve 
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <CustomText variant="caption" weight="medium">Frontend Development</CustomText>
                    <CustomText variant="caption" color="accent">95%</CustomText>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <CustomText variant="caption" weight="medium">Backend Development</CustomText>
                    <CustomText variant="caption" color="accent">90%</CustomText>
                  </div>
                  <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <CustomText variant="caption" weight="medium">UI/UX Design</CustomText>
                    <CustomText variant="caption" color="accent">85%</CustomText>
                  </div>
                  <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <CustomText variant="caption" weight="medium">DevOps</CustomText>
                    <CustomText variant="caption" color="accent">80%</CustomText>
                  </div>
                  <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
