export const siteContent = Object.freeze({
  profile: {
    ...
    availability:
      'Open to freelance builds, contract delivery, and strong product teams.',
  ...
  systemSignals: [
    {
      ...
      detail:
        'Frontend content is served from a Node endpoint rather than hard-coded into the UI.',
      tone: 'support',
    },
    {
      label: 'contact flow',
      ...
      detail:
        'Submissions are sanitized, rate-limited, and written to local storage with a reference id.',
      tone: 'accent',
    },
    {
      label: 'ops posture',
      ...
      detail:
        'Health checks, request ids, and Docker support are included in the delivery path.',
      tone: 'accent',
    },
  ],
});
