      ...
      <Container>
        ...
        <header className="mt-8 border-b border-border pb-10">
          ...
          <dl className="mt-8 grid gap-6 sm:grid-cols-2">
            <div>
              <dt className="text-xs uppercase tracking-[0.14em] text-text-faint">Role</dt>
              <dd className="mt-1.5 text-sm text-text">{project.role}</dd>
            </div>
            <div>
              <dt className="text-xs uppercase tracking-[0.14em] text-text-faint">Stack</dt>
        ...
        >
          {previous ? (
            <Link
              ...
              className="group rounded-xl border border-border p-4 transition-colors hover:border-border-strong"
            >
          ...
          {next ? (
            <Link
              to={`/work/${next.slug}`}
              className="group rounded-xl border border-border p-4 text-right transition-colors hover:border-border-strong sm:justify-self-end"
            >
              <span className="inline-flex items-center gap-1.5 text-xs text-text-faint">
